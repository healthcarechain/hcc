...
const string strMessageMagic = "HealthCareChain Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees) 
{
    ...
    {
      nSubsidy = 1998000 * COIN;
      return nSubsidy + nFees;
    }
	
	else if (pindexBest->nHeight+1 < 501)
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HealthCareChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "HealthCareChain blockchain 2017/6/16 8:8:1";
        CTransaction txNew;
        txNew.nTime = 1497625681;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1497625681;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3813770;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc49808bf4a671405214a67a5f709fe4cc1c17808ff623dcc02616b4b37512ccb"));
