...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("HealthCareChain-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("HealthCareChain-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("HealthCareChain-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HealthCareChain " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("HealthCareChain-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("HealthCareChain-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("HealthCareChain-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("HealthCareChain-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HealthCareChain is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("HealthCareChain-start");
